...
public class CamelKafkaBreakOnFirstErrorWithSynchCommit {
    private static final Logger LOGGER = LoggerFactory.getLogger(CamelKafkaBreakOnFirstErrorWithSynchCommit.class);
